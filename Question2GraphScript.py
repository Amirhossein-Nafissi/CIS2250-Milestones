...
# Plot bar graph
plt.bar(positions-width, index, width, label='Most Frequent Index', color='red')
plt.bar(positions+width, index2, width, label='Second Most Frequent Index', color='blue')
